...
public class Main {
    ...
    private static void flightManagementMenu() {
        ...
        while (!back) {
            ...
            System.out.println("6. Process Waiting Flights");
    ...
    private static void departureMenu() {
        ...
        while (!back) {
            ...
            System.out.println("2. Complete Departure");
            System.out.println("3. Show Departed List");
            System.out.println("4. Clear Departed Flights File");
    ...
    private static void arrivalMenu() {
        ...
        while (!back) {
            ...
            System.out.println("2. Complete Arrival");
            System.out.println("3. Show Arrived Flights");
            System.out.println("4. Clear Arrived Flights File");
            System.out.println("0. Back");
            printSeparator();
            System.out.print("  Enter choice: ");
    ...
    private static void passengerManagementMenu() {
        ...
        while (!back) {
            ...
            System.out.println("2. Display cancelled bookings");
            System.out.println("0. Back");
            printSeparator();
            System.out.print("  Enter choice: ");
